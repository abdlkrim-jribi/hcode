...
class MCPServerConfig(BaseModel):
    ...
    command: Optional[str] = Field(default=None, description="For stdio: the executable, e.g. 'npx'")
    args: list[str] = Field(default_factory=list, description="For stdio: command arguments")
    url: Optional[str] = Field(default=None, description="For http: the server URL")
    ...
    description: str = Field(default="", description="Human-readable description of this server")
...
# Pre-built templates for commonly used MCP servers
...
class MCPConfigManager:
    ...
    def __init__(self, root_dir: Optional[str] = None) -> None:
        ...
        self.config_path: Path = self.root_dir / ".hcode" / "mcp_config.json"

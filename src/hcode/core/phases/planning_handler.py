        ...
        try:
            ...
            if project_knowledge:
                pk_section = (
                    ...
                    ">\n"
                    "> **How to use it during planning**:\n"
                    "> - Use it to locate files and understand module boundaries — do not invent paths.\n"
                    "> - Follow the naming conventions and architectural patterns it describes.\n"
                    "> - Identify which modules are affected by the task before writing `task.md`.\n"
                    "> - Do NOT plan changes that contradict the documented architecture without good reason.\n\n"
                    + project_knowledge
                )
            else:
                pk_section = "(No project knowledge found. Run `/init` to generate `hcode.md` for richer context.)"

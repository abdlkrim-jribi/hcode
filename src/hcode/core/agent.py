...
def format_thinking_display(block: ThinkingBlock, console: Console) -> None:
    ...
    Uses the modern UI theme system for consistent styling.
    ...
    if block.risk_check:
        ...
        content.append(risk_line[:60], style=palette.text_muted)
...
What specific action will you take to address this error?"""
                ...
                if task_completed:
                    # Use themed success message
                    self.console.print(f"[bold {self._palette.success}]{self._icons.SUCCESS} Task completed![/bold {self._palette.success}]")
